...
////////////////////////////////////////////////////////////////////////
	...
	public String getSearchedPathname(
		int	index)
	{
	...
	public void addAggregate(
		TextSearcher.AggregateResult	result)
	{
		if (!elements.isEmpty())
	...
	////////////////////////////////////////////////////////////////////
			...
			char	commentPrefix)
		{
			...
			if (text != null)
			{
				if (buffer.length() > 0)
					buffer.append("  ");
				buffer.append(commentPrefix).append(' ').append(text);
			}
			return buffer.toString();
		}
