...
import uk.org.blankaspect.gui.SingleTextFieldDialog;
...
class ParameterEditor
    extends JPanel
    implements ChangeListener, ListEditor.TextModel
{
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
            ...
            private static String showDialog( Component parent,
                                              ...
                                              String    pattern )
            {
                ItemDialog dialog = new ItemDialog( GuiUtilities.getWindow( parent ), titleStr, paramKind,
                                                    pattern );
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private void onCopy( )
        {
            try
            {
                Util.putClipboardText( textArea.getText( ) );
            }
...
////////////////////////////////////////////////////////////////////////
                            ...
                            EscapeListener escapeListener )
    {
        ...
        tabSurrogate = AppConfig.getInstance( ).getTabSurrogate( );
        ...
        // Text area
        textArea = new TextArea( AppConfig.getInstance( ).getTargetAndReplacementTabWidth( ) );
        ...
        Dimension editorSize = AppConfig.getInstance( ).getParameterEditorSize( );
...
////////////////////////////////////////////////////////////////////////
    ...
    public String toActionText( String str )
    {
        return ( (itemsSubmenu == null)
                    ? str
                    : TextUtilities.getLimitedWidthString( escape( str ), itemsSubmenu.getFontMetrics(
                                                                                itemsSubmenu.getFont( ) ),
                                                           MAX_MENU_ITEM_WIDTH,
                                                           TextUtilities.RemovalMode.END ) );
    }
