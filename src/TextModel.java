...
////////////////////////////////////////////////////////////////////////
                      ...
                      char         tabGlyphChar )
    {
        ...
        if ( file != null )
        {
            for ( TabWidthFilter filter : AppConfig.getInstance( ).getTabWidthFilters( ) )
            {
        ...
        if ( tabWidth < 0 )
            tabWidth = AppConfig.getInstance( ).getDefaultTabWidth( );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        EnumMap<LineSeparator, Integer> lineSeparatorCounts =
                                    TextFile.changeLineSeparators( text, AppConfig.getInstance( ).
...
////////////////////////////////////////////////////////////////////////
//  Instance methods : TextArea.Model interface
////////////////////////////////////////////////////////////////////////
                                     ...
                                     int endIndex )
    {
        ...
        char[] spaces = StringUtilities.createCharArray( ' ', tabWidth );
        int index = 0;
        for ( int i = i0; i < i1; ++i )
        {
        ...
        throws AppException
    {
        if ( changed )
        {
            ...
            TextFile.write( file, getCharacterEncoding( ), outBuffer,
                            AppConfig.getInstance( ).getFileWritingMode( ) );
        }
    }
