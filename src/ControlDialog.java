...
import uk.org.blankaspect.gui.ArrowButton;
...
import uk.org.blankaspect.gui.SingleSelectionListEditor;
...
import uk.org.blankaspect.util.InputModifiers;
import uk.org.blankaspect.util.KeyAction;
import uk.org.blankaspect.util.PathnameFilter;
...
class ControlDialog
    extends JDialog
    implements ActionListener, MouseListener, PathnameField.ImportListener
{
...
////////////////////////////////////////////////////////////////////////
    ...
    private static final    String  INSERT_FILE_SET_TOOLTIP_STR         = "Insert a new file set (F2)";
    private static final    String  DUPLICATE_FILE_SET_TOOLTIP_STR      = "Duplicate the current file " +
                                                                            "set (F3)";
    private static final    String  DELETE_FILE_SET_TOOLTIP_STR         = "Delete the current file set " +
                                                                            "(F4)";
    private static final    String  GO_TO_FILE_SET_START_TOOLTIP_STR    = "Go to the start of the " +
                                                                            "file-set list (F5)";
    private static final    String  GO_TO_FILE_SET_END_TOOLTIP_STR      = "Go to the end of the file-set " +
                                                                            "list (F8)";
    private static final    String  GO_TO_FILE_SET_PREVIOUS_TOOLTIP_STR = "Go to the previous file set " +
                                                                            "(F6), or move the file set " +
                                                                            "up (Ctrl+F6)";
    private static final    String  GO_TO_FILE_SET_NEXT_TOOLTIP_STR     = "Go to the next file set (F7), " +
                                                                            "or move the file set down " +
                                                                            "(Ctrl+F7)";
    private static final    String  ESCAPE_TARGET_TOOLTIP_STR           = "Escape the target text";
    private static final    String  ESCAPE_REPLACEMENT_TOOLTIP_STR      = "Escape the replacement text";
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private EscapeIndicator( String text )
        {
            ...
            preferredWidth = Math.max( preferredWidth,
                                       2 * HORIZONTAL_MARGIN + fontMetrics.stringWidth( text ) );
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
...

        {
            ...
            setDirection( (scrollDirection == ScrollDirection.BACKWARD) ? Direction.LEFT
                                                                        : Direction.RIGHT );
            if ( !bar )
...
////////////////////////////////////////////////////////////////////////
    ...
    private ControlDialog( MainWindow mainWindow )
    {
        ...
        Box.Filler fileSetControlPanelFiller = GuiUtilities.createFiller( );
        ...
        GuiUtilities.setPaddedLineBorder( fileSetCommandPanel, 3, 5 );
        Color backgroundColour = fileSetCommandPanel.getBackground( );
        if ( backgroundColour != null )
            fileSetCommandPanel.setBackground( ColourUtilities.scaleBrightness( backgroundColour,
                                                                                0.9375f ) );
        ...
        insertFileSetButton.setToolTipText( INSERT_FILE_SET_TOOLTIP_STR );
        ...
        duplicateFileSetButton.setToolTipText( DUPLICATE_FILE_SET_TOOLTIP_STR );
        ...
        deleteFileSetButton.setToolTipText( DELETE_FILE_SET_TOOLTIP_STR );
        ...
        GuiUtilities.setPaddedLineBorder( fileSetNavigationPanel, 2 );
        ...
        fileSetStartButton.setToolTipText( GO_TO_FILE_SET_START_TOOLTIP_STR );
        ...
        fileSetPreviousButton.setToolTipText( GO_TO_FILE_SET_PREVIOUS_TOOLTIP_STR );
        ...
        fileSetNextButton.setToolTipText( GO_TO_FILE_SET_NEXT_TOOLTIP_STR );
        ...
        fileSetEndButton.setToolTipText( GO_TO_FILE_SET_END_TOOLTIP_STR );
        ...
        inclusionFilterEditor = new FilterEditor( FileSet.FilterKind.INCLUSION, FileSet.MAX_NUM_FILTERS,
                                                  true );
        ...
        exclusionFilterEditor = new FilterEditor( FileSet.FilterKind.EXCLUSION, FileSet.MAX_NUM_FILTERS,
                                                  false );
        ...
        // Editor: target
        targetEditor = new ParameterEditor( ParameterEditor.ParamKind.TARGET,
                                            SearchParameters.MAX_NUM_TARGETS, '\\',
                                            targetEscapeStatusPanel );
        JButton escapeButton = targetEditor.getEscapeButton( );
        escapeButton.setToolTipText( ESCAPE_TARGET_TOOLTIP_STR );
        ...
        replacementEditor = new ParameterEditor( ParameterEditor.ParamKind.REPLACEMENT,
                                                 ...
                                                 config.getReplacementEscapeChar( ),
                                                 replacementEscapeStatusPanel );

        escapeButton = replacementEditor.getEscapeButton( );
        escapeButton.setToolTipText( ESCAPE_REPLACEMENT_TOOLTIP_STR );
        ...
        mainPanel.setTransferHandler( FileTransferHandler.getInstance( ) );
        ...
        if ( location == null )
            location = GuiUtilities.getComponentLocation( this, mainWindow );
        setLocation( GuiUtilities.getLocationWithinScreen( this, location ) );
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        return App.getInstance( ).getSearchParams( );
    }
...
////////////////////////////////////////////////////////////////////////
//  Instance methods : PathnameField.ImportListener interface
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        else
        {
            ...
            {
                GuiUtilities.setFocus( pathnameEditor );
                throw e;
            }
        }
        ...
        try
        {
            ...
            if ( StringUtilities.isNullOrEmpty( targetStr ) )
                throw new AppException( ErrorId.NO_TARGET );
        }
        catch ( AppException e )
        {
            GuiUtilities.setFocus( targetEditor );
            throw e;
        }
        if ( isRegex( ) )
        {
    ...
    private void onDeleteFileSet( )
    {
        ...
        if ( JOptionPane.showOptionDialog( this, DELETE_MESSAGE_STR, DELETE_FILE_SET_STR,
    ...
    {
        if ( isRegex( ) )
            targetEditor.setText( StringUtilities.escape( targetEditor.getText( ),
                                                          AppConfig.getInstance( ).
                                                                            getEscapedMetacharacters( ) ) );
    }
    ...
    private void onEscapeReplacement( )
    {
        ...
        String escapePrefix = Character.toString( AppConfig.getInstance( ).getReplacementEscapeChar( ) );
