...
////////////////////////////////////////////////////////////////////////
                                  ...
                                  TabWidthFilter filter )
    {
        ...
        // Spinner: tab width
        int tabWidth = (filter == null) ? AppConfig.getInstance( ).getDefaultTabWidth( )
                                        : filter.getTabWidth( );
...
////////////////////////////////////////////////////////////////////////
    ...
    public static TabWidthFilter showDialog( Component      parent,
                                             ...
                                             TabWidthFilter filter )
    {
        return new TabWidthFilterDialog( GuiUtilities.getWindow( parent ), titleStr, filter ).
                                                                                    getTabWidthFilter( );
    }
...
////////////////////////////////////////////////////////////////////////
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( filterField );
            throw e;
        }
    }
