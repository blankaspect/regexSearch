...
import uk.org.blankaspect.gui.SinglePathnameFieldDialog;
...
import uk.org.blankaspect.util.ListEditor;
...
class PathnameEditor
    extends JPanel
    implements ListEditor.TextModel
{
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////
                                    ...
                                    String pathname )
            {
                super( owner, titleStr, KEY, PATHNAME_STR, pathname, 0,
                       AppConfig.getInstance( ).isShowUnixPathnames( ) );
            }
        ...
        ////////////////////////////////////////////////////////////////
            ...
            private static String showDialog( Component parent,
                                              ...
                                              String    pathname )
            {
                PathnameDialog dialog = new PathnameDialog( GuiUtilities.getWindow( parent ), titleStr,
                                                            pathname );
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private TextField( )
        {
            ...
            GuiUtilities.setPaddedLineBorder( this, VERTICAL_MARGIN, HORIZONTAL_MARGIN );
            setForeground( AppConstants.TEXT_COLOUR );
            setDisabledTextColor( Util.getDisabledTextColour( ) );
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private void onCopy( )
        {
            try
            {
                Util.putClipboardText( pathnameField.getText( ) );
            }
...
////////////////////////////////////////////////////////////////////////
                                    ...
                                    File      file )
    {
        if ( fileChooser == null )
        {
            fileChooser = new JFileChooser( SystemUtilities.getUserHomePathname( ) );
...
////////////////////////////////////////////////////////////////////////
//  Instance methods : ListEditor.TextModel interface
////////////////////////////////////////////////////////////////////////
    ...
    public String toActionText( String str )
    {
        return ( (itemsSubmenu == null)
                    ? str
                    : TextUtilities.getLimitedWidthPathname( str, itemsSubmenu.getFontMetrics(
...
////////////////////////////////////////////////////////////////////////
    ...
    public void addImportListener( PathnameField.ImportListener listener )
    {
    ...
    private void showContextMenu( MouseEvent event )
    {
        if ( isEnabled( ) && ((event == null) || event.isPopupTrigger( )) )
        {
            ...
            // Display menu
            Util.showContextMenu( contextMenu, this, event );
        }
    }
