...
////////////////////////////////////////////////////////////////////////
                                     ...
                                     int endIndex )
    {
        ...
        for ( int i = startIndex; i < endIndex; ++i )
        {
            ...
            int endOffset = (element.selected && (element.pathname != null)) ? element.pathname.length( )
                                                                             : 0;
...
////////////////////////////////////////////////////////////////////////
    ...
    public void addFile( TextSearcher.FileResult result )
    {
        ...
        elements.add( new Element( Util.getPathname( result.file ), buffer.toString( ), true ) );
        fireStateChanged( );
    }
                          ...
                          boolean    fullPathname )
    {
        ...
        for ( File file : files )
            elements.add( new Element( fullPathname ? Util.getPathname( file ) : file.getPath( ), null,
                                       false ) );
        fireStateChanged( );
    }
